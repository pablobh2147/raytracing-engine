...
bool Renderer::Initialize(const RendererConfig& config) noexcept {
    ...
    if (!CreateDescriptorSets()) {
        Logger::Error("Renderer", "Failed to create descriptor set");
        return false;
    }
